export default function Page(params: { params: {name: string} }) {
  ...
  const data = {
    ...
    rank: 1,
    year: 2023,
    introduction: "IAS (Indian Administrative Service) is one of the most prestigious and sought-after careers in India...",
    father: "John Doe Sr.",
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <h1 className="text-3xl font-bold mb-4">{data.name} ({data.service})</h1>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">Optional Subjects:</h2>
